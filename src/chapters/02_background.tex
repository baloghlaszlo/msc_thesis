...
System development is a complex process, therefore it needs to be supported by various tools and algorithms. In this chapter the background of our work \citep{tdk2015}  and my previous BSc thesis \citep{bsc_thesis} is introduced towards an approach supporting correct system design.
\todo{Ide meg kell valami}
